...
function robo_trade_sell(){
	Volume.findOne({'MarketName' : 'BTC-SFCC'},function(err,volume){
		if (volume)
		{
			var last = parseFloat(volume.last);
			var quantity = parseInt(_.random(100,500));
			var rand_price_add  = parseInt(_.random(80,300));
...
function initssss() {
    var myFunction = function() {
        robo_trade_sell();
        var rand = Math.round(Math.random() * (15000 - 500)) + 100000; 
